...
export enum IpcAction {
  ...
  // Mention Data
  RECIEVE_MENTION_DATA = 'RECIEVE_MENTION_DATA',
  GET_MENTION_DATA = 'GET_MENTION_DATA',
  SET_MENTION_DATA = 'SET_MENTION_DATA',
  ...
  // * PIN NOTE PREVIEW WINDOW
  PIN_NOTE_WINDOW = 'PIN_NOTE_WINDOW',
  SHOW_PINNED_NOTE_WINDOW = 'SHOW_PINNED_NOTE_WINDOW',
  UNPIN_NOTE = 'UNPIN_NOTE',

  // * ILINKS
  UPDATE_ILINKS = 'UPDATE_ILINKS',
