...
/**
 * Taken from: https://github.com/mrdoob/three.js/blob/master/examples/jsm/renderers/CSS2DRenderer.js
 *
 * Required for rendering nodes in graph.
 *
 * Typescript is fucked in this file.
 *
